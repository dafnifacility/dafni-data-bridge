...
for YEAR in range(2024,2025):
    ...
    "area": [72,-15,34,35],}# N/W/S/E
        target = '/gws/pw/j07/ceraf/hbloomfield01/Data/ERA5/ERA5_EU_1hr_rsds_' + str(YEAR) + '_' + str(m) + '.nc'
        client = cdsapi.Client()
        client.retrieve(dataset, request,target)#.download()

# , ,'total_precipitation',], had to do accumilated as a seperate field or they come out zipped!