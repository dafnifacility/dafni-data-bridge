...
dataset-download-tool --no_auth --url "https://gws-access.jasmin.ac.uk/public/acpc/acpc/pmarin/Base_States_Apr2020/CAPE_CIN_basestateshear_pdifML500_.pdf" --dest ./data/ --checksum

# 7. From SSH
dataset-download-tool --ssh "ip.jasmin.ac.uk" --username username -key_file ~/.ssh/jasmin.key --ssh-download-path /gws/path/to/file --dest ./data/
